    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        ...
        <div class="navbar-nav ml-auto">
          <a class="nav-item nav-link " id="hl" href="alumni_events.php" >Events</a>
            ...
            <a class="nav-item nav-link active" id="hl" href="depart_chat.php" >Department Chat</a>
...
<div class="d-flex justify-content-center" style="padding-top: 0%;padding-bottom: 5%">
  <div class="card bg-light" >
    ...
    <p align="center"><a href="depart_classmates.php" style="text-decoration:none">Click here to view Your Group Members</a></p>
</div></div>
</div></div>
