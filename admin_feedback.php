...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        ...
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link active" id="hl" href="admin_feedback.php" >Feedbacks</a>
...
<div class="card">
    <div class="card-body text-center">
      <div class="table-responsive">
          <table class="table">
            <tr><th>S.No</th><th>Name</th><th>Department</th><th>Feedback</th></tr>
        <?php
          include 'db.php';
          $cn=$_SESSION['department'];
          if($_SESSION['prior']!='D')
          {
          $sql="SELECT * FROM feedback WHERE department='$cn' ORDER BY sno";
          if($res=mysqli_query($con,$sql))
          {
            ...
            {
                ?><tr><td><?php echo $row['sno']; ?></td><td><?php echo $row['name']; ?></td><td><?php echo $row['department']; ?></td><td><?php echo $row['feedback']; ?></td></tr><?php
            }
          }
          else
          {
            ?><tr><td colspan="4">Sorry!No Feedbacks</td></tr><?php
          }
          }
          else
          {
        ...
        {
            $sql="SELECT * FROM feedback ORDER BY sno";
          if($res=mysqli_query($con,$sql))
          {
            if(mysqli_num_rows($res)!=0)
            {
          ...
          {
            ?><tr><td colspan="3">Sorry!No Feedbacks</td></tr><?php
          }
          }
          else
          {
