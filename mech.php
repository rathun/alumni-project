...
<img src="Image/mech.png" width=100%>
<div class="card">
    <div class="card-body">
    	<p style="text-align: center;font-size: 30px"><i>List of Alumni Members in Mechanical Engineering</i></p>
      <?php
        if(isset($_SESSION['key']) && $_SESSION['key']==1)
        {
          ?>
              <div class="card-deck justify-content-center">
                   <div class="shadow-lg p-3 mb-5 bg-white rounded" style="font-size: 15px;height: 20%;width: 20%">
                    <form id="frm">
                      <input type="hidden" name="dept" value="B.E.MECHANICAL">
